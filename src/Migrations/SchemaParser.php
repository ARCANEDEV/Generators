<?php namespace Arcanedev\Generators\Migrations;

use Illuminate\Contracts\Support\Arrayable;

/**
 * Class SchemaParser
 * @package Arcanedev\Generators\Migrations
 */
class SchemaParser implements Arrayable
{
    ...
    public function parse($schema)
    {
        ...
        foreach ($this->getSchemas() as $schemaArray) {
            ...
            $parsed[$column] = $this->getAttributes($column, $schemaArray);
        }
    ...
    /**
     * Determinate whether the given column is exist in customAttributes array.
     *
     * @param string $column
     *
     * @return bool
